...
# def load_documents_unstructured(directory):
#     """
#     Loads all PDF documents from a specified directory using unstructured.
#     This method is better for complex layouts, tables, and images.
#     """
#     try:
#         logging.info(f"Loading documents from directory: {directory}")
#         if not os.path.exists(directory):
...
# documents = load_documents_unstructured(directory)

# # The output format for 'unstructured' is a list of Element objects.
# # You can iterate through these elements to access the text.
# if documents:
...
#             # 💡 Access the context and print the retrieved chunks
#             print("\n--- Retrieved Chunks ---")
#             for i, doc in enumerate(response['context']):
#                 print(f"Chunk {i+1} from {doc.metadata.get('source', 'Unknown source')}:\n{doc.page_content}\n")
#             print("------------------------")
